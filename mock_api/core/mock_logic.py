"""
Probabilistic mock logic for the Mock Chatbot API.
...
_INTENT_DB: list[dict] = [
    {
        ...
        "responses": [
            "Tuition depends on your chosen program. Bachelor programs start from €6,390/year and Master programs from €7,560/year. Flexible payment plans are available!",
            "We offer competitive fees: Bachelor programs from €6,390/year (online) and Master programs from €7,560/year. Many programs include free learning materials.",
    ...
    },
    {
        ...
        "responses": [
            "Enrolling is simple! Submit your application online at our website, upload your documents, and our admissions team will review within 2–3 business days.",
            "To apply: 1) Choose your program, 2) Submit your application online, 3) Upload your documents. You can start enrollment year-round — no fixed intake dates!",
            "You can enroll anytime. The process takes about 1–2 weeks. You'll need your school-leaving certificate and a valid ID. Ready to begin your application?",
        ],
    },
    {
        ...
        "responses": [
            "We offer 200+ programs including Business Administration, Computer Science, Psychology, Engineering, and more — available fully online or on-campus.",
            ...
            "We have programs in Business, Tech, Health, and Social Sciences. All programs are accredited and internationally recognized. Which field interests you most?",
        ],
    },
    {
        ...
        "responses": [
            "We operate on a flexible semester model. Standard semesters run October–March (Winter) and April–September (Summer). You can start mid-semester too!",
            "The academic year is divided into two semesters: Winter (October–March) and Summer (April–September). Course deadlines are flexible for online students.",
            "Semesters last approximately 6 months. Online programs offer rolling enrollment. Exam periods are at the end of each semester.",
        ],
    },
    {
        ...
        "responses": [
            "We offer various scholarships including merit-based awards (up to 30% fee reduction) and need-based grants. Contact our financial aid office to check eligibility.",
            ...
            "We provide comprehensive student support: scholarships, payment plans, a dedicated student advisor for each learner, and 24/7 online student services.",
        ],
    },
    {
        ...
        "responses": [
            ...
            "My advice: choose a program aligned with your passion AND market demand. Our most in-demand programs are Data Science, Business Administration, and Computer Science.",
        ],
    },
    {
        "intent": "exam_inquiry",
        ...
        "responses": [
            "For most online programs, we use portfolio-based assessments (assignments and projects) rather than traditional exams. Some programs include proctored online exams.",
            "Grades follow the standard scale (1.0–5.0) where 1.0 is the best. You need at least 4.0 (pass) in each assessment. Results are published within 4 weeks.",
            "We use a mix of written assignments, case studies, and online exams. For online programs, most assessments are submitted digitally. Pass mark is typically 50%.",
        ],
    },
    # Conversational wrappers — LAST (lose ties to domain intents)
    {
        ...
        "responses": [
            "Hello! Welcome to our University. How can I help you today?",
            "Hi there! I'm your student advisor. What can I assist you with?",
            "Hey! Great to connect. What would you like to know about our programs?",
        ],
    },
    {
        "intent": "farewell",
        ...
        "responses": [
            "Thank you for reaching out! Best of luck with your studies.",
            "Goodbye! Don't hesitate to contact us again if you have more questions.",
            "It was a pleasure helping you. We look forward to welcoming you!",
        ],
    },
]
...
_FALLBACK_RESPONSES = [
    ...
    "I'm here to help with questions about our programs, fees, and enrollment. Could you elaborate?",
...
_HALLUCINATION_RESPONSES = [
    ...
    "Did you know our university was founded in 1998?",
